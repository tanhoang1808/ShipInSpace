...
public class BulletImpart : HoangMonoBehaviour
{
    ...
    {
        if (other.transform.parent.name == BulletCtrl.Instance.Shooter.name || other.CompareTag("Bullet") || other.CompareTag("Enemy"))
        {
            
            return;
        };
       
        BulletCtrl.Instance.DamageSender.Send(other.transform);
